    ...
    return (
        <div className='w-full flex items-center justify-center border-t-5 border-red-500 md:border-t-0'>
            <section className="bg-red-400 w-1/2 h-screen overflow-hidden hidden md:block">
                <Image priority src="https://res.cloudinary.com/jose-galdamez-dev/image/upload/f_auto,q_auto/v1/Restaurant-QR/nbyofps0v2u9dwbtmxqc" className='h-screen w-full object-center object-cover opacity-20' width={1000} height={1000} alt="Fondo Login" />
            </section>
